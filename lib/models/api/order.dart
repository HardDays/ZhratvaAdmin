...
class Order {
  ...
  Order({this.id, this.restaurantId, this.user, this.userId, this.currency, this.orderStatus, this.price, this.carryOption, this.peopleCount, this.orderMenuItems, this.date, this.restaurant, this.createdAt});
